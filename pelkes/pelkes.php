<script type="text/javascript">
	$(document).ready(function(){
		$("#data").load("pelkes/data_pelkes.php");
		$("#id-breadcrumbs").html("Pelayanan Kesehatan");
	});
